...
// 应用版本更新
// 查询最新应用版本信息
export const getAppLastVersion  = params => {
  return get(`/app/last-version`, params)
}
...
// 鉴权
// 用户登出
export const postAuthLogout  = params => {
  return post(`/auth/logout`, params)
}

// 鉴权
// 用户修改密码
export const putAuthPassword  = params => {
  return put(`/auth/password`, params)
}

// 鉴权
// 用户忘记密码
export const putAuthResetPassword  = params => {
  return put(`/auth/reset-password`, params)
}

// 鉴权
// 用户激活
export const putAuthActive  = params => {
  return put(`/auth/active`, params)
}

// 鉴权
// 用户注册
export const postAuthRegister  = params => {
  return post(`/auth/register`, params)
}

// 鉴权
// 发送短信验证码
export const postAuthVerifyCode  = params => {
  return post(`/auth/verify-code`, params)
}

// 重庆看板
// 被监控特种设备维保情况
export const getChongqingBoardMaintenanceStatistics  = params => {
  return get(`/chongqing-board/maintenance-statistics`, params)
}

// 重庆看板
// 被监控企业安全培训情况(累计)  安全培训
export const getChongqingBoardSafetyTraining  = params => {
  return get(`/chongqing-board/safety-training`, params)
}

// 重庆看板
// 企业详情
export const getChongqingBoardEnterpriseDetail  = params => {
  return get(`/chongqing-board/enterprise-detail`, params)
}

// 重庆看板
// 被监控特种设备类型占比
export const getChongqingBoardSpecialPercentage  = params => {
  return get(`/chongqing-board/special-percentage`, params)
}

// 重庆看板
// 被监控企业应急演练情况(累计)
export const getChongqingBoardEmergencyStatistics  = params => {
  return get(`/chongqing-board/emergency-statistics`, params)
}

// 重庆看板
// 被监控企业隐患排查情况(累计)
export const getChongqingBoardDangerStatistics  = params => {
  return get(`/chongqing-board/danger-statistics`, params)
}

// 重庆看板
// 企业统计
export const getChongqingBoardEnterpriseStatistics  = params => {
  return get(`/chongqing-board/enterprise-statistics`, params)
}

// 处理进度
// 时间轴
export const getWfInsIdHistoryItems  = params => {
  return get(`/wf/ins/${params.id}/history-items`, params)
}

// 处理进度
// 信息项
export const getWfTaskIdInfoItems  = params => {
  return get(`/wf/task/${params.id}/info-items`, params)
}

// 流程管理
// 初始节点
export const getWfNodeStartNodes  = params => {
  return get(`/wf/node/start-nodes`, params)
}

// 流程管理
// 节点详情
export const getWfNodeDetailId  = params => {
  return get(`/wf/node/detail/${params.id}`, params)
}

// 流程管理
// 初始节点的物资列表（分页）
export const postWfNodeIdMaterials  = params => {
  return post(`/wf/node/${params.id}/materials`, params)
}

// 流程管理
// 查询操作项（物资组模板与节点操作关联时）
export const getWfNodeIdOperationItems  = params => {
  return get(`/wf/node/${params.id}/operation-items`, params)
}

// 流程管理
// 我的上报（分页）
export const postWfInsSubmitted  = params => {
  return post(`/wf/ins/submitted`, params)
}

// 流程管理
// 我的处理（分页）
export const postWfInsProcessed  = params => {
  return post(`/wf/ins/processed`, params)
}

// 流程管理
// 历史纪录（分页）
export const postWfInsHistory  = params => {
  return post(`/wf/ins/history`, params)
}

// 流程管理
// 我的待办列表（分页）
export const postWfTaskMy  = params => {
  return post(`/wf/task/my`, params)
}

// 流程管理
// 企业待办列表（分页）
export const postWfTaskAll  = params => {
  return post(`/wf/task/all`, params)
}

// 流程管理
// 待办详情
export const getWfTaskDetailId  = params => {
  return get(`/wf/task/detail/${params.id}`, params)
}

// 流程管理
// 任务高级指派
export const postWfTaskAssign  = params => {
  return post(`/wf/task/assign`, params)
}

// 流程管理
// 高级指派人员
export const getWfTaskAssignees  = params => {
  return get(`/wf/task/assignees`, params)
}

// 流程管理
// 任务指派人
export const getWfTaskOperationsIdAssignors  = params => {
  return get(`/wf/task/operations/${params.id}/assignors`, params)
}

// 流程管理
// 节点提交
export const postWfInsNodesOperation  = params => {
  return post(`/wf/ins/nodes-operation`, params)
}

// 流程管理
// 判断当前场景下当前物资是否可以发起流程，针对串行场景
export const getWfInsStartCheck  = params => {
  return get(`/wf/ins/start-check`, params)
}

// 流程管理
// 节点转接操作匹配查询
export const getWfInsNodeTransferMatch  = params => {
  return get(`/wf/ins/node-transfer/match`, params)
}

// 流程管理
// 流程处理人（分页）
export const getWfInsAssignees  = params => {
  return get(`/wf/ins/assignees`, params)
}

// 流程管理
// 流程处理人（本企业待办+跨企业待办）
export const getWfInsV1Assignees  = params => {
  return get(`/wf/ins/v1/assignees`, params)
}

// 流程管理
// 删除流程实例
export const delWfInsId  = params => {
  return del(`/wf/ins/${params.id}`, params)
}

// 流程管理
// 已经启用的流程
export const getWfConfigStartedWfs  = params => {
  return get(`/wf/config/started-wfs`, params)
}
...
// 公用接口
// 获取企业全部用户（下拉框使用）
export const getCommonAllUserIdAndRealname  = params => {
  return get(`/common/all-user-id-and-realname`, params)
}

// 公用接口
// 文件上传初始化
export const getCommonUploadInit  = params => {
  return get(`/common/upload-init`, params)
}

// 公用接口
// 地址服务
export const getCommonLocations  = params => {
  return get(`/common/locations`, params)
}

// 公用接口
// 获取组织架构树
export const getCommonOrganizationsTrees  = params => {
  return get(`/common/organizations-trees`, params)
}

// 公用接口
// 模板下载
export const getCommonDownloadTemplatesType  = params => {
  return get(`/common/download-templates/${params.type}`, params)
}

// 数据权限
// 获取数据权限详情
export const postDataRulesDetail  = params => {
  return post(`/data-rules/detail`, params)
}

// 数据权限
// 编辑数据权限
export const postDataRules  = params => {
  return post(`/data-rules`, params)
}

// 数据仪表盘
// 数据查询
export const postDashboardChart  = params => {
  return post(`/dashboard/chart`, params)
}

// 数据仪表盘
// 仪表盘中报表的查询条件
export const getDashboardReportsReport_idQueryCondition  = params => {
  return get(`/dashboard/reports/${params.report_id}/query-condition`, params)
}
...
// 数据仪表盘
// 状态栏数据
export const postDashboardStatusData  = params => {
  return post(`/dashboard/status-data`, params)
}

// 数据仪表盘
// 任务栏数据
export const postDashboardTaskData  = params => {
  return post(`/dashboard/task-data`, params)
}

// 数据仪表盘
// 组件文本数据查询
export const getDashboardComponentsIdText  = params => {
  return get(`/dashboard/components/${params.id}/text`, params)
}

// 数据仪表盘
// 流程状态查询
export const getDashboardWorkflowStatus  = params => {
  return get(`/dashboard/workflow-status`, params)
}

// 数据仪表盘
// 仪表盘详情
export const getDashboardId  = params => {
  return get(`/dashboard/${params.id}`, params)
}

// 企业字典
// 删除配置项
export const delDictionaryDefinitionsConfigId  = params => {
  return del(`/dictionary/definitions/config/${params.id}`, params)
}

// 企业字典
// 企业字典导入
export const postDictionaryDefinitionsImport  = params => {
  return post(`/dictionary/definitions/import`, params)
}

// 企业字典
// 列表查询（从根节点开始）
export const getDictionaryDefinitionsFromRoot  = params => {
  return get(`/dictionary/definitions/from-root`, params)
}

// 企业字典
// 通过ID批量查询
export const postDictionaryDefinitionsByIds  = params => {
  return post(`/dictionary/definitions/by-ids`, params)
}

// 企业字典
// 查询子节点
export const getDictionaryDefinitionsQueryChild  = params => {
  return get(`/dictionary/definitions/query/child`, params)
}

// 企业字典
// 查询固定层级
export const getDictionaryDefinitionsQueryFloor  = params => {
  return get(`/dictionary/definitions/query/floor`, params)
}

// 企业字典
// 企业字典信息保存
export const postDictionaryDefinitions  = params => {
  return post(`/dictionary/definitions`, params)
}
...
// 企业信息管理
// 提交企业信息
export const postEnterprises  = params => {
  return post(`/enterprises`, params)
}

// 企业信息管理
// 合作企业列表
export const getEnterprisesCooperateEnterprises  = params => {
  return get(`/enterprises/cooperate-enterprises`, params)
}

// 信息项管理
// 信息项模板列表
export const getInfoItemTemplates  = params => {
  return get(`/info-item/templates`, params)
}

// 信息项管理
// 信息项模板编辑
export const putInfoItemTemplates  = params => {
  return put(`/info-item/templates`, params)
}

// 信息项管理
// 信息项模板基本信息
export const getInfoItemTemplatesId  = params => {
  return get(`/info-item/templates/${params.id}`, params)
}

// 信息项管理
// 信息项模板配置信息
export const getInfoItemTemplatesIdConfigs  = params => {
  return get(`/info-item/templates/${params.id}/configs`, params)
}

// 信息项管理
// 数据源列表
export const getInfoItemDataSources  = params => {
  return get(`/info-item/data-sources`, params)
}

// 数据报表
// 全部报表信息
export const getReportsAll  = params => {
  return get(`/reports/all`, params)
}

// 数据报表
// 明细报表列表
export const getReportsDetailedReports  = params => {
  return get(`/reports/detailed-reports`, params)
}
...
// 数据报表
// 报表查询条件
export const getReportsIdQueryConditions  = params => {
  return get(`/reports/${params.id}/query-conditions`, params)
}

// 数据报表
// 明细报表查询条件
export const getReportsDetailedReportsIdQueryConditions  = params => {
  return get(`/reports/detailed-reports/${params.id}/query-conditions`, params)
}

// 数据报表
// 报表内容
export const postReportsId  = params => {
  return post(`/reports/${params.id}`, params)
}

// 数据报表
// 明细报表内容
export const postReportsDetailedReportsId  = params => {
  return post(`/reports/detailed-reports/${params.id}`, params)
}

// 数据报表
// 报表内容导出为excel
export const postReportsIdExportExcel  = params => {
  return post(`/reports/${params.id}/export-excel`, params)
}

// 数据报表
// 明细报表内容导出为excel
export const postReportsDetailedReportsIdExportExcel  = params => {
  return post(`/reports/detailed-reports/${params.id}/export-excel`, params)
}

// 企业看板
// 企业看板配置
export const getViewBoardConfigs  = params => {
  return get(`/view-board/configs`, params)
}

// 企业看板
// 文本转语音
export const getViewBoardVoice  = params => {
  return get(`/view-board/voice`, params)
}

// 企业看板
// 指定位置的内容
export const getViewBoardPositionIdContent  = params => {
  return get(`/view-board/position/${params.id}/content`, params)
}

// 设备关联
// 创建功能关联设备
export const postEquipmentsFunctionRelations  = params => {
  return post(`/equipments/function-relations`, params)
}

// 设备关联
// 删除功能关联设备
export const delEquipmentsFunctionRelations  = params => {
  return del(`/equipments/function-relations`, params)
}

// 设备关联
// 功能关联设备列表
export const postEquipmentsFunctionRelationList  = params => {
  return post(`/equipments/function-relation-list`, params)
}

// 数据导出
// 导出列表
export const postExportWorkflowRecordLists  = params => {
  return post(`/export/workflow-record/lists`, params)
}

// 数据导出
// 导出操作
export const postExportWorkflowRecordExcel  = params => {
  return post(`/export/workflow-record/excel`, params)
}

// 数据导出
// 查询条件
export const getExportWorkflowRecordStartedWfs  = params => {
  return get(`/export/workflow-record/started-wfs`, params)
}

// 公用接口
// 一级分组
export const getCommonAllLv1Groups  = params => {
  return get(`/common/all-lv1-groups`, params)
}

// 公用接口
// 二级分组
export const getCommonAllLv2GroupsByLv1Id  = params => {
  return get(`/common/all-lv2-groups-by-lv1-id`, params)
}

// 公用接口
// 二级分组
export const getCommonAllLv2Groups  = params => {
  return get(`/common/all-lv2-groups`, params)
}

// 物资分组
// 分组列表（分页）
export const postGroupsMaterialLists  = params => {
  return post(`/groups/material-lists`, params)
}

// 物资分组
// 分组树
export const getGroupsTreeByMaterials  = params => {
  return get(`/groups/tree-by-materials`, params)
}

// 物资分组
// 加入物资组
export const postGroupsIdMaterials  = params => {
  return post(`/groups/${params.id}/materials`, params)
}

// 物资分组
// 移除物资组
export const delGroupsIdMaterials  = params => {
  return del(`/groups/${params.id}/materials`, params)
}

// 物资分组
// 更换物资组
export const putGroupsMaterials  = params => {
  return put(`/groups/materials`, params)
}

// 班组
// 分组列表(分页)
export const postUserGroupsLists  = params => {
  return post(`/user-groups/lists`, params)
}

// 班组
// 分组树
export const getUserGroupsTree  = params => {
  return get(`/user-groups/tree`, params)
}

// 班组
// 加入班组
export const postUserGroupsIdUsers  = params => {
  return post(`/user-groups/${params.id}/users`, params)
}

// 班组
// 移除班组
export const delUserGroupsIdUsers  = params => {
  return del(`/user-groups/${params.id}/users`, params)
}

// 班组
// 更换班组
export const putUserGroupsUsers  = params => {
  return put(`/user-groups/users`, params)
}

// 设备点检
// 内容管理列表
export const getMachinesCheckupContentManagement  = params => {
  return get(`/machines/checkup/content-management`, params)
}

// 设备点检
// 点检表分组列表
export const getMachinesCheckupFormGroup  = params => {
  return get(`/machines/checkup/form-group`, params)
}

// 设备点检
// 配置点检组
export const postMachinesCheckupFormGroup  = params => {
  return post(`/machines/checkup/form-group`, params)
}

// 设备点检
// 删除点检组
export const delMachinesCheckupFormGroup  = params => {
  return del(`/machines/checkup/form-group`, params)
}

// 设备点检
// 获取点检表详情
export const getMachinesCheckupCheckupForm  = params => {
  return get(`/machines/checkup/checkup-form`, params)
}

// 设备点检
// 编辑点检表
export const putMachinesCheckupCheckupForm  = params => {
  return put(`/machines/checkup/checkup-form`, params)
}

// 设备点检
// 新增点检表
export const postMachinesCheckupCheckupForm  = params => {
  return post(`/machines/checkup/checkup-form`, params)
}

// 设备点检
// 删除点检表
export const delMachinesCheckupCheckupForm  = params => {
  return del(`/machines/checkup/checkup-form`, params)
}

// 设备点检
// 复制点检表
export const putMachinesCheckupCheckupFormCopy  = params => {
  return put(`/machines/checkup/checkup-form-copy`, params)
}

// 设备点检
// 点检表下拉列表
export const getMachinesCheckupCheckupFormNames  = params => {
  return get(`/machines/checkup/checkup-form-names`, params)
}

// 设备点检
// 内容管理模板导入
export const postMachinesCheckupFormImport  = params => {
  return post(`/machines/checkup/form-import`, params)
}

// 设备点检
// 点检记录
export const postMachinesCheckupOperationsList  = params => {
  return post(`/machines/checkup/operations/list`, params)
}

// 设备点检
// 点检记录
export const getMachinesCheckupOperationsId  = params => {
  return get(`/machines/checkup/operations/${params.id}`, params)
}

// 设备点检
// 有点检记录的设备列表
export const postMachinesCheckupOperationsMaterials  = params => {
  return post(`/machines/checkup/operations/materials`, params)
}

// 设备点检
// 点检表导出
export const postMachinesCheckupOperationsFormsExport  = params => {
  return post(`/machines/checkup/operations/forms-export`, params)
}

// 设备点检
// 关联设备列表
export const postMachinesCheckupRelationMaterialLists  = params => {
  return post(`/machines/checkup/relation-material-lists`, params)
}

// 设备点检
// 创建关联关系
export const postMachinesCheckupRelationMaterials  = params => {
  return post(`/machines/checkup/relation-materials`, params)
}

// 设备点检
// 删除关联关系
export const delMachinesCheckupRelationMaterials  = params => {
  return del(`/machines/checkup/relation-materials`, params)
}

// 设备点检
// 设备导入
export const postMachinesCheckupRelationMaterialsImport  = params => {
  return post(`/machines/checkup/relation-materials-import`, params)
}

// 设备点检
// 点检设备管理列表
export const postMachinesCheckupSettingMaterialLists  = params => {
  return post(`/machines/checkup/setting-material-lists`, params)
}

// 设备点检
// 停检设置保存
export const postMachinesCheckupSettingMaterialPause  = params => {
  return post(`/machines/checkup/setting-material-pause`, params)
}

// 设备点检
// 删除停检设置
export const delMachinesCheckupSettingMaterialPause  = params => {
  return del(`/machines/checkup/setting-material-pause`, params)
}

// 设备点检
// 点检设置详情
export const getMachinesCheckupSettingDetails  = params => {
  return get(`/machines/checkup/setting-details`, params)
}

// 设备点检
// 点检开关
export const putMachinesCheckupSetting  = params => {
  return put(`/machines/checkup/setting`, params)
}

// 设备点检
// 获取点检流程
export const getMachinesCheckupWorkflow  = params => {
  return get(`/machines/checkup/workflow`, params)
}

// 设备点检
// 编辑点检流程
export const putMachinesCheckupWorkflow  = params => {
  return put(`/machines/checkup/workflow`, params)
}

// 设备点检
// 获取流程下拉列表
export const getMachinesCheckupWorkflowNames  = params => {
  return get(`/machines/checkup/workflow-names`, params)
}

// 设备点检
// 点检错误汇总
export const postMachinesCheckupErrors  = params => {
  return post(`/machines/checkup/errors`, params)
}

// 设备点检
// 点检执行跟踪列表
export const postMachinesCheckupFollowList  = params => {
  return post(`/machines/checkup/follow-list`, params)
}

// 设备点检
// 点检跟踪详情
export const getMachinesCheckupFollowDetail  = params => {
  return get(`/machines/checkup/follow-detail`, params)
}

// 设备点检
// 导出点检执行跟踪
export const postMachinesCheckupFollowExport  = params => {
  return post(`/machines/checkup/follow-export`, params)
}

// 设备点检
// 点检错误汇总导出
export const postMachinesCheckupErrorsExport  = params => {
  return post(`/machines/checkup/errors-export`, params)
}

// 设备点检
// 导出点检设备列表
export const postMachinesCheckupSettingMaterialExport  = params => {
  return post(`/machines/checkup/setting-material-export`, params)
}

// 设备点检
// 获取点检班次列表
export const getMachinesCheckupSchedules  = params => {
  return get(`/machines/checkup/schedules`, params)
}

// 设备点检
// 获取标准列表
export const getMachinesCheckupStandard  = params => {
  return get(`/machines/checkup/standard`, params)
}

// 设备点检
// 新增标准
export const postMachinesCheckupStandard  = params => {
  return post(`/machines/checkup/standard`, params)
}

// 设备点检
// 删除标准
export const delMachinesCheckupStandard  = params => {
  return del(`/machines/checkup/standard`, params)
}

// 设备点检
// 获取标准详情
export const getMachinesCheckupStandardId  = params => {
  return get(`/machines/checkup/standard/${params.id}`, params)
}

// 设备点检
// 编辑标准
export const putMachinesCheckupStandardId  = params => {
  return put(`/machines/checkup/standard/${params.id}`, params)
}

// 设备点检
// 点检获取指定企业存在点检类型
export const getMachinesCheckupStandardsExistTypes  = params => {
  return get(`/machines/checkup/standards/exist-types`, params)
}

// 设备状态
// 设备状态列表（分页）
export const postMachinesStatusMaterialLists  = params => {
  return post(`/machines/status/material-lists`, params)
}

// 设备状态
// 设备状态统计
export const getMachinesStatusStatistics  = params => {
  return get(`/machines/status/statistics`, params)
}

// 设备状态
// 设备状态数据字典
export const getMachinesStatusDictionary  = params => {
  return get(`/machines/status/dictionary`, params)
}

// 设备开关机
// 开关机列表（分页）
export const postMachinesSwitchMaterialLists  = params => {
  return post(`/machines/switch/material-lists`, params)
}

// 设备开关机
// 新增开关机设备列表（分页）
export const postMachinesSwitchAddMaterials  = params => {
  return post(`/machines/switch/add-materials`, params)
}

// 设备开关机
// 新增开关机设备
export const postMachinesSwitchMaterials  = params => {
  return post(`/machines/switch/materials`, params)
}

// 设备开关机
// 删除开关机设备
export const delMachinesSwitchMaterials  = params => {
  return del(`/machines/switch/materials`, params)
}

// 设备开关机
// 开关机日志（分页）
export const getMachinesSwitchSwitchLogs  = params => {
  return get(`/machines/switch/switch-logs`, params)
}

// 设备开关机
// 计划开机时长修改
export const postMachinesSwitchPlanDuration  = params => {
  return post(`/machines/switch/plan-duration`, params)
}

// 设备开关机
// 开关机物资带属性类别列表
export const getMachinesSwitchCategoryWithAttr  = params => {
  return get(`/machines/switch/category-with-attr`, params)
}

// 设备开关机
// 操作来源列表
export const getMachinesSwitchOperatorRef  = params => {
  return get(`/machines/switch/operator-ref`, params)
}

// 设备开关机
// 删除开关机日志
export const delMachinesSwitchLogs  = params => {
  return del(`/machines/switch/logs`, params)
}

// 设备开关机
// 操作人列表
export const getMachinesSwitchOperators  = params => {
  return get(`/machines/switch/operators`, params)
}

// 设备开关机
// 开关机通知列表
export const getMachinesSwitchNotices  = params => {
  return get(`/machines/switch/notices`, params)
}

// 设备开关机
// 新增开关机通知
export const postMachinesSwitchNotices  = params => {
  return post(`/machines/switch/notices`, params)
}

// 设备开关机
// 开关机通知详情
export const getMachinesSwitchNoticesId  = params => {
  return get(`/machines/switch/notices/${params.id}`, params)
}

// 设备开关机
// 编辑开关机通知
export const putMachinesSwitchNoticesId  = params => {
  return put(`/machines/switch/notices/${params.id}`, params)
}

// 设备开关机
// 删除开关机通知
export const delMachinesSwitchNoticesId  = params => {
  return del(`/machines/switch/notices/${params.id}`, params)
}

// 分类管理
// 分类列表（分页）
export const getCategoriesLists  = params => {
  return get(`/categories/lists`, params)
}

// 分类管理
// 全部分类(高级搜索，数据列表等场景)
export const getCategoriesAll  = params => {
  return get(`/categories/all`, params)
}
...
// 分类管理
// 分类详情（对象新增、对象编辑）
export const getCategoriesIdForMaterialEdit  = params => {
  return get(`/categories/${params.id}/for-material-edit`, params)
}

// 对象管理
// 一级列表
export const postMaterialsDefLists  = params => {
  return post(`/materials/def-lists`, params)
}

// 公用接口
// 物资定义列表（目前使用场景只有数据列表）
export const postCommonMaterialsDefLists  = params => {
  return post(`/common/materials/def-lists`, params)
}

// 对象管理
// 对象定义详情
export const getMaterialsDefDetailIdForEdit  = params => {
  return get(`/materials/def-detail/${params.id}/for-edit`, params)
}

// 对象管理
// 对象定义详情
export const getMaterialsDefDetailId  = params => {
  return get(`/materials/def-detail/${params.id}`, params)
}

// 对象管理
// 新增定义
export const postMaterialsDef  = params => {
  return post(`/materials/def`, params)
}

// 对象管理
// 修改定义
export const putMaterialsDefId  = params => {
  return put(`/materials/def/${params.id}`, params)
}

// 对象管理
// 删除定义
export const delMaterialsDefId  = params => {
  return del(`/materials/def/${params.id}`, params)
}

// 对象管理
// 导出对象
export const postMaterialsExport  = params => {
  return post(`/materials/export`, params)
}

// 对象管理
// 导入对象
export const postMaterialsImport  = params => {
  return post(`/materials/import`, params)
}

// 对象管理
// 下载模板
export const getMaterialsImportTemplate  = params => {
  return get(`/materials/import-template`, params)
}

// 对象管理
// 导入记录（分页）
export const getMaterialsImportLists  = params => {
  return get(`/materials/import-lists`, params)
}

// 对象管理
// 对象二级列表
export const postMaterialsInsLists  = params => {
  return post(`/materials/ins-lists`, params)
}

// 公用接口
// 对象二级列表（目前使用场景只有发起流程）
export const postCommonMaterialsInsLists  = params => {
  return post(`/common/materials/ins-lists`, params)
}

// 对象管理
// 对象实例详情
export const getMaterialsInsDetailIdForEdit  = params => {
  return get(`/materials/ins-detail/${params.id}/for-edit`, params)
}

// 对象管理
// 对象实例详情
export const getMaterialsInsDetailId  = params => {
  return get(`/materials/ins-detail/${params.id}`, params)
}

// 公用接口
// 对象实例详情（主要场景是业务模块展示物资信息，目前主要是流程详情，计划详情等）
export const getCommonMaterialsInsDetailId  = params => {
  return get(`/common/materials/ins-detail/${params.id}`, params)
}

// 对象管理
// 新增实例
export const postMaterialsIns  = params => {
  return post(`/materials/ins`, params)
}

// 对象管理
// 修改实例
export const putMaterialsInsId  = params => {
  return put(`/materials/ins/${params.id}`, params)
}

// 对象管理
// 删除实例
export const delMaterialsInsId  = params => {
  return del(`/materials/ins/${params.id}`, params)
}

// 对象组织机构
// 组织机构列表（分页）
export const postMaterialsOrganizationLists  = params => {
  return post(`/materials/organization-lists`, params)
}

// 对象组织机构
// 组织机构树
export const getMaterialsOrganizationTree  = params => {
  return get(`/materials/organization-tree`, params)
}

// 对象组织机构
// 加入/移除/更换组织机构
export const postMaterialsOrganizationSave  = params => {
  return post(`/materials/organization-save`, params)
}

// 物资组织机构
// 物资组织机构列表新接口
export const postMaterialsNewOrganizationList  = params => {
  return post(`/materials/new-organization-list`, params)
}

// 对象管理
// 获取可以成为子对象的对象列表（分页）
export const postMaterialsCanBeChildLists  = params => {
  return post(`/materials/can-be-child-lists`, params)
}

// 对象管理
// 获取关联对象（子父对象）
export const postMaterialsRelations  = params => {
  return post(`/materials/relations`, params)
}

// 对象管理
// 对象关联备件（分页）
export const postMaterialsSparePartHistoryLists  = params => {
  return post(`/materials/spare-part-history-lists`, params)
}

// 功能权限
// 获取当前用户菜单
export const getModuleAuthMenus  = params => {
  return get(`/module-auth/menus`, params)
}

// 功能权限
// 获取企业的全量菜单
export const getModuleAuthMenusEnterpriseAll  = params => {
  return get(`/module-auth/menus/enterprise-all`, params)
}

// 功能权限
// 角色列表
export const getModuleAuthRoles  = params => {
  return get(`/module-auth/roles`, params)
}

// 功能权限
// 角色创建
export const postModuleAuthRoles  = params => {
  return post(`/module-auth/roles`, params)
}

// 功能权限
// 角色删除
export const delModuleAuthRoles  = params => {
  return del(`/module-auth/roles`, params)
}

// 功能权限
// 角色选择列表
export const getModuleAuthRolesSelect  = params => {
  return get(`/module-auth/roles/select`, params)
}

// 功能权限
// 角色详情
export const getModuleAuthRolesId  = params => {
  return get(`/module-auth/roles/${params.id}`, params)
}

// 功能权限
// 角色更新
export const putModuleAuthRolesId  = params => {
  return put(`/module-auth/roles/${params.id}`, params)
}

// 功能权限
// 角色授权
export const postModuleAuthRolesAssign  = params => {
  return post(`/module-auth/roles/assign`, params)
}

// 功能权限
// 用户被授权角色列表
export const getModuleAuthRolesByUsers  = params => {
  return get(`/module-auth/roles/by-users`, params)
}
...
// 业务监控
// 新增业务监控
export const postMonitors  = params => {
  return post(`/monitors`, params)
}

// 业务监控
// 编辑业务监控
export const putMonitorsModification  = params => {
  return put(`/monitors/modification`, params)
}

// 业务监控
// 删除业务监控
export const delMonitorsDestruction  = params => {
  return del(`/monitors/destruction`, params)
}

// 业务监控
// 业务监控详情
export const getMonitorsDetail  = params => {
  return get(`/monitors/detail`, params)
}

// 业务监控
// 获取触发流程
export const getMonitorsWorkflow  = params => {
  return get(`/monitors/workflow`, params)
}

// 业务监控
// 获取节点信息项
export const getMonitorsPlanContent  = params => {
  return get(`/monitors/plan-content`, params)
}

// 组织架构管理
// 新增组织架构
export const postOrganizations  = params => {
  return post(`/organizations`, params)
}

// 组织架构管理
// 编辑组织架构
export const putOrganizationsId  = params => {
  return put(`/organizations/${params.id}`, params)
}

// 组织架构管理
// 删除组织架构
export const delOrganizationsId  = params => {
  return del(`/organizations/${params.id}`, params)
}

// 组织架构管理
// 组织架构树
export const getOrganizationsTrees  = params => {
  return get(`/organizations/trees`, params)
}

// 组织架构管理
// 导入
export const postOrganizationsExcels  = params => {
  return post(`/organizations/excels`, params)
}

// 组织架构管理
// 批量分配
export const postOrganizationsUserOrganizationRelations  = params => {
  return post(`/organizations/user-organization-relations`, params)
}

// 组织架构管理
// 设置/取消管理员
export const putOrganizationsIdUsersUser_id  = params => {
  return put(`/organizations/${params.id}/users/${params.user_id}`, params)
}

// 组织架构管理
// 人员列表
export const getOrganizationsUsers  = params => {
  return get(`/organizations/users`, params)
}

// 计划管理
// 计划列表(参数都通过body发送，文档稍后修改)
export const postPlansList  = params => {
  return post(`/plans/list`, params)
}

// 计划管理
// 新增计划
export const postPlans  = params => {
  return post(`/plans`, params)
}

// 计划管理
// 计划详情
export const getPlansId  = params => {
  return get(`/plans/${params.id}`, params)
}

// 计划管理
// 编辑计划
export const putPlansId  = params => {
  return put(`/plans/${params.id}`, params)
}

// 计划管理
// 删除计划
export const delPlansId  = params => {
  return del(`/plans/${params.id}`, params)
}

// 计划管理
// 计划启停
export const putPlansIdStatus  = params => {
  return put(`/plans/${params.id}/status`, params)
}

// 计划管理
// 查询业务场景
export const getPlansWorkflow  = params => {
  return get(`/plans/workflow`, params)
}

// 计划管理
// 查询开始节点（根据场景）一并返回是否有过程节点
export const getPlansStartNodeByWorkflow  = params => {
  return get(`/plans/start-node-by-workflow`, params)
}

// 计划管理
// 查询节点操作（根据计划操作节点）
export const getPlansOperationByNode  = params => {
  return get(`/plans/operation-by-node`, params)
}

// 计划管理
// 查询计划处理人
export const getPlansOperators  = params => {
  return get(`/plans/operators`, params)
}

// 计划管理
// 查询物资组对应的物资定义集合
export const getPlansGroupMaterials  = params => {
  return get(`/plans/group-materials`, params)
}

// 计划管理
// 检验触发节点是否不指派自己
export const getPlansCheckAssignSelf  = params => {
  return get(`/plans/check-assign-self`, params)
}

// 计划管理
// 获取节点信息项
export const getPlansPlanContent  = params => {
  return get(`/plans/plan-content`, params)
}

// 单据
// 铭牌样式配置获取
export const getPressworkNameplatesStyleConfig  = params => {
  return get(`/presswork/nameplates/style-config`, params)
}

// 单据
// 铭牌样式配置保存
export const postPressworkNameplatesStyleConfig  = params => {
  return post(`/presswork/nameplates/style-config`, params)
}

// 单据
// 铭牌格式检测
export const getPressworkNameplatesCheckFormat  = params => {
  return get(`/presswork/nameplates/check-format`, params)
}

// 单据
// 单据设置获取
export const getPressworkConfig  = params => {
  return get(`/presswork/config`, params)
}

// 单据
// 单据设置保存
export const putPressworkConfig  = params => {
  return put(`/presswork/config`, params)
}

// 单据
// 单据下载
export const getPressworkDownload  = params => {
  return get(`/presswork/download`, params)
}

// 单据
// 单据查看
export const getPressworkShow  = params => {
  return get(`/presswork/show`, params)
}

// 单据
// 单据设置操作日志
export const getPressworkConfigLogs  = params => {
  return get(`/presswork/config/logs`, params)
}

// 单据
// 模板单文档列表
export const getPressworkTemplates  = params => {
  return get(`/presswork/templates`, params)
}

// 单据
// 模板单文档添加
export const postPressworkTemplates  = params => {
  return post(`/presswork/templates`, params)
}

// 单据
// 模板单文档详情
export const getPressworkTemplatesId  = params => {
  return get(`/presswork/templates/${params.id}`, params)
}

// 单据
// 模板单文档更新
export const putPressworkTemplatesId  = params => {
  return put(`/presswork/templates/${params.id}`, params)
}

// 单据
// 模板单文档删除
export const delPressworkTemplatesId  = params => {
  return del(`/presswork/templates/${params.id}`, params)
}

// 排班管理
// 新增排班
export const postSchedules  = params => {
  return post(`/schedules`, params)
}
...
// 排班管理
// 编辑排班
export const putSchedulesId  = params => {
  return put(`/schedules/${params.id}`, params)
}

// 排班管理
// 删除排班
export const delSchedulesId  = params => {
  return del(`/schedules/${params.id}`, params)
}

// 排班管理
// 导出
export const getSchedulesExcels  = params => {
  return get(`/schedules/excels`, params)
}

// 排班管理
// 导入
export const postSchedulesExcels  = params => {
  return post(`/schedules/excels`, params)
}

// 排班管理
// 查询人员列表
export const getSchedulesUsers  = params => {
  return get(`/schedules/users`, params)
}

// 排班管理
// 批量排班
export const postSchedulesUserScheduleRelations  = params => {
  return post(`/schedules/user-schedule-relations`, params)
}

// 排班管理
// 获取企业的全部班组
export const getSchedulesGroups  = params => {
  return get(`/schedules/groups`, params)
}

// 排班管理
// 新增班组
export const postSchedulesGroups  = params => {
  return post(`/schedules/groups`, params)
}

// 排班管理
// 班组详情
export const getSchedulesGroupsId  = params => {
  return get(`/schedules/groups/${params.id}`, params)
}

// 排班管理
// 编辑班组
export const postSchedulesGroupsId  = params => {
  return post(`/schedules/groups/${params.id}`, params)
}

// 排班管理
// 删除班组
export const delSchedulesGroupsId  = params => {
  return del(`/schedules/groups/${params.id}`, params)
}

// 特种设备
// 特种设备列表（分页，无内置限定）
export const postSpecialEquipmentSpecialEquipments  = params => {
  return post(`/special-equipment/special-equipments`, params)
}

// 特种设备
// 特种设备详情
export const getSpecialEquipmentSpecialEquipmentsId  = params => {
  return get(`/special-equipment/special-equipments/${params.id}`, params)
}

// 特种设备
// 获取某特种设备的关联对象（子父对象）
export const postSpecialEquipmentSpecialEquipmentRelations  = params => {
  return post(`/special-equipment/special-equipment-relations`, params)
}

// 特种设备
// 按企业聚合
export const postSpecialEquipmentCollectByEnterprise  = params => {
  return post(`/special-equipment/collect-by-enterprise`, params)
}

// 特种设备
// 当前企业下监管所有设备
export const getSpecialEquipmentAllStat  = params => {
  return get(`/special-equipment/all-stat`, params)
}

// 特种设备
// 当前企业监管特种设备数量
export const getSpecialEquipmentCount  = params => {
  return get(`/special-equipment/count`, params)
}

// 特种设备
// 当前企业所监管某企业特种设备查询
export const getSpecialEquipmentStat  = params => {
  return get(`/special-equipment/stat`, params)
}

// 特种设备
// 当前企业所监管企业使用情况查询
export const getSpecialEquipmentEnterpriseUsage  = params => {
  return get(`/special-equipment/enterprise-usage`, params)
}

// 特种设备
// 当前企业监管特种设备的维保情况
export const getSpecialEquipmentMaintenanceStatistics  = params => {
  return get(`/special-equipment/maintenance-statistics`, params)
}

// 特种设备
// 当前企业监管特种设备的各类型占比情况
export const getSpecialEquipmentTypePercentage  = params => {
  return get(`/special-equipment/type-percentage`, params)
}

// 特种设备
// 根据流程类型获取相关特种设备
export const postSpecialEquipmentWorkflowTypeWorkflow_typeLists  = params => {
  return post(`/special-equipment/workflow-type/${params.workflow_type}/lists`, params)
}

// 特种设备
// 根据流程类型获取相关特种设备（超期流程）
export const postSpecialEquipmentWorkflowTypeListsOfReportOverdue  = params => {
  return post(`/special-equipment/workflow-type/lists-of-report-overdue`, params)
}

// 特种设备
// 特种设备附属设备情况查询
export const getSpecialEquipmentSubsidiaryEquipmentStatistics  = params => {
  return get(`/special-equipment/subsidiary-equipment-statistics`, params)
}

// 特种设备
// 当前企业的被监管企业应急演练情况（累计）
export const getSpecialEquipmentEmergencyDrillStatistics  = params => {
  return get(`/special-equipment/emergency-drill-statistics`, params)
}

// 特种设备
// 当前企业的被监管企业隐患排查情况（累计）
export const getSpecialEquipmentHiddenDangerEliminationStatistics  = params => {
  return get(`/special-equipment/hidden-danger-elimination-statistics`, params)
}

// 特种设备
// 当前企业的被监管企业安全培训情况（累计）
export const getSpecialEquipmentSafetyTrainingStatistics  = params => {
  return get(`/special-equipment/safety-training-statistics`, params)
}

// 特种设备
// 当前企业看板信息
export const getSpecialEquipmentBoardInfo  = params => {
  return get(`/special-equipment/board-info`, params)
}

// 特种设备
// 当前企业监管的特种设备企业统计
export const getSpecialEquipmentEnterpriseStatistics  = params => {
  return get(`/special-equipment/enterprise-statistics`, params)
}

// 特种设备
// 当前企业监管的特种设备企业全部列表
export const getSpecialEquipmentEnterpriseAll  = params => {
  return get(`/special-equipment/enterprise-all`, params)
}

// 特种设备
// 当前企业监管的特种设备企业列表
export const getSpecialEquipmentEnterpriseList  = params => {
  return get(`/special-equipment/enterprise-list`, params)
}

// 特种设备
// 安全部门列表
export const getSpecialEquipmentSecurityOrganizationsAll  = params => {
  return get(`/special-equipment/security-organizations-all`, params)
}

// 特种设备
// 获取特种设备的分类集合
export const postSpecialEquipmentCategories  = params => {
  return post(`/special-equipment/categories`, params)
}

// 特种设备
// 特种设备历史记录
export const postSpecialEquipmentWfHistories  = params => {
  return post(`/special-equipment/wf-histories`, params)
}

// 特种设备
// 组织架构人员列表
export const getSpecialEquipmentOrganizationUsers  = params => {
  return get(`/special-equipment/organization-users`, params)
}

// 用户信息管理
// 用户绑定
export const postUsersBind  = params => {
  return post(`/users/bind`, params)
}

// 用户信息管理
// 用户解绑
export const postUsersUnbind  = params => {
  return post(`/users/unbind`, params)
}

// 用户信息管理
// 根据 username 添加用户获取用户信息
export const getUsersUserForStore  = params => {
  return get(`/users/user-for-store`, params)
}
...
// 用户信息管理
// 编辑用户
export const putUsersId  = params => {
  return put(`/users/${params.id}`, params)
}

// 用户信息管理
// 导出用户
export const getUsersExcels  = params => {
  return get(`/users/excels`, params)
}

// 用户信息管理
// 批量修改用户信息
export const putUsersExcels  = params => {
  return put(`/users/excels`, params)
}

// 用户信息管理
// 导入用户
export const postUsersExcels  = params => {
  return post(`/users/excels`, params)
}

// 云库房
// 物资分类
export const getWarehousesIdCategoriesAll  = params => {
  return get(`/warehouses/${params.id}/categories/all`, params)
}

// 云库房盘存
// 盘存列表
export const getWarehousesCorrections  = params => {
  return get(`/warehouses/corrections`, params)
}

// 云库房盘存
// 新增盘存
export const postWarehousesCorrections  = params => {
  return post(`/warehouses/corrections`, params)
}

// 云库房盘存
// 盘存详情
export const getWarehousesCorrectionsId  = params => {
  return get(`/warehouses/corrections/${params.id}`, params)
}

// 云库房盘存
// 更新盘存
export const putWarehousesCorrectionsId  = params => {
  return put(`/warehouses/corrections/${params.id}`, params)
}

// 云库房盘存
// 删除盘存
export const delWarehousesCorrectionsId  = params => {
  return del(`/warehouses/corrections/${params.id}`, params)
}

// 云库房盘存
// 盘存归档
export const postWarehousesCorrectionsIdArchiving  = params => {
  return post(`/warehouses/corrections/${params.id}/archiving`, params)
}

// 云库房
// 出入库记录（分页）
export const getWarehousesReceipts  = params => {
  return get(`/warehouses/receipts`, params)
}

// 云库房
// 出入库
export const postWarehousesReceipts  = params => {
  return post(`/warehouses/receipts`, params)
}

// 云库房
// 出入库记录导出
export const getWarehousesReceiptsExcels  = params => {
  return get(`/warehouses/receipts/excels`, params)
}

// 云库房
// 库位列表(分页)
export const getWarehousesIdSlots  = params => {
  return get(`/warehouses/${params.id}/slots`, params)
}

// 云库房
// 库位新增
export const postWarehousesIdSlots  = params => {
  return post(`/warehouses/${params.id}/slots`, params)
}

// 云库房
// 库位编辑
export const putWarehousesIdSlotsSlot_id  = params => {
  return put(`/warehouses/${params.id}/slots/${params.slot_id}`, params)
}

// 云库房
// 编辑库位物料
export const postWarehousesIdSlotsSlot_idMaterials  = params => {
  return post(`/warehouses/${params.id}/slots/${params.slot_id}/materials`, params)
}

// 云库房
// 人员列表（分页）
export const getWarehousesIdUsers  = params => {
  return get(`/warehouses/${params.id}/users`, params)
}

// 云库房
// 人员新增
export const postWarehousesIdUsers  = params => {
  return post(`/warehouses/${params.id}/users`, params)
}

// 云库房
// 人员启用/禁用
export const putWarehousesIdUsersUser_id  = params => {
  return put(`/warehouses/${params.id}/users/${params.user_id}`, params)
}

// 云库房
// 获取全部库房
export const getWarehousesAll  = params => {
  return get(`/warehouses/all`, params)
}

// 云库房
// 获取指定库房配置详情
export const getWarehousesIdConfigs  = params => {
  return get(`/warehouses/${params.id}/configs`, params)
}

// 云库房
// 编辑库房配置
export const putWarehousesIdConfigs  = params => {
  return put(`/warehouses/${params.id}/configs`, params)
}

// 云库房
// 获取指定库房下接受预警的手机号
export const getWarehousesIdReceiversAll  = params => {
  return get(`/warehouses/${params.id}/receivers/all`, params)
}

// 云库房
// 编辑指定库房下接受预警的手机号
export const putWarehousesIdReceiversAll  = params => {
  return put(`/warehouses/${params.id}/receivers/all`, params)
}

// 云库房
// 库存详情
export const getWarehousesIdMaterialsMaterial_id  = params => {
  return get(`/warehouses/${params.id}/materials/${params.material_id}`, params)
}

// 云库房
// 编辑物料属性（预警值等）
export const putWarehousesIdMaterialsMaterial_id  = params => {
  return put(`/warehouses/${params.id}/materials/${params.material_id}`, params)
}

// 云库房
// 出入库物资列表
export const getWarehousesIdMaterials  = params => {
  return get(`/warehouses/${params.id}/materials`, params)
}

// 云库房
// 库存列表（库存预警设置列表）
export const getWarehousesStocks  = params => {
  return get(`/warehouses/stocks`, params)
}

// 云库房
// 库存记录导出
export const getWarehousesStocksExcels  = params => {
  return get(`/warehouses/stocks/excels`, params)
}

// 云库房
// 获取指定库房指定物资的物资详情(带库位和批次信息）最大只支持1000个物料
export const getWarehousesIdMaterialWithBatchDetails  = params => {
  return get(`/warehouses/${params.id}/material-with-batch-details`, params)
}

// 云库房
// 出入库物资列表(新)
export const postWarehousesMaterialsV2  = params => {
  return post(`/warehouses/materials-v2`, params)
}

// 云库房
// 物资分类v2
export const getWarehousesIdCategoriesAllV2  = params => {
  return get(`/warehouses/${params.id}/categories/all-v2`, params)
}
